...
return {
	...
	settings = {
		vtsls = {
			experimental = {
				completion = {
					...
					entriesLimit = 20, -- tune to taste
				},
			},
			tsserver = {
				maxTsServerMemory = 8192, -- cap memory, forces lazy loading
				watchOptions = {
		...
		typescript = {
			...
			tsserver = {
				experimental = {
					enableProjectDiagnostics = false, -- don't lint the whole project, only open files
				},
			},
		},
	},
